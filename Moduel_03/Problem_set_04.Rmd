...
* How does the measure of diversity depend on the definition of species in your samples?
  Depending on how grain-fined.
  -Species Definition Rule:
    - Sampling method should be consistent in respect to the environment
    - Define clearly "species" -> 97%
    - Use the same region for 16sRrna analysis
    - Same primer
    - Use curatect database
    - Processing sample, ie, some methods may not lyse the entire population
